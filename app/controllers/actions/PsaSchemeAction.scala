...
class PsaSchemeActionImpl (srn:SchemeReferenceNumber, schemeDetailsConnector: SchemeDetailsConnector, errorHandler: ErrorHandler)
...
class PsaSchemeAction @Inject() (schemeDetailsConnector: SchemeDetailsConnector, errorHandler: ErrorHandler)(implicit ec: ExecutionContext){
  def apply(srn: SchemeReferenceNumber) = new PsaSchemeActionImpl(srn, schemeDetailsConnector, errorHandler)
