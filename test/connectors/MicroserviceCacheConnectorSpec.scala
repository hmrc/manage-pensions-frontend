...
class MicroserviceCacheConnectorSpec extends AsyncWordSpec with MustMatchers with ConnectorBehaviour {
  ...
  "UserAnswersCacheConnector" must {
    behave like cacheConnector[UserAnswersCacheConnector](userAnswersCacheConnectorUrl, userAnswersCacheConnectorLastUpdatedUrl)
  }
