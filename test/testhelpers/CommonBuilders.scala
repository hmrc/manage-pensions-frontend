...
object CommonBuilders {
  ...
  val psaSchemeDetailsResponse = PsaSchemeDetails(mockSchemeDetails, Nil, Nil, Some(Seq(psaDetails1, psaDetails2)))
  val schemeDetailsWithPsaOnlyResponse = PsaSchemeDetails(mockSchemeDetails, Nil, Nil, Some(Seq(psaDetails1, psaDetails2)))
  val schemeDetailsPendingResponse = PsaSchemeDetails(mockSchemeDetails.copy(status = "Pending"), Nil, Nil, Some(Seq(psaDetails1, psaDetails2)))
  val schemeDetailsWithoutPsaResponse = PsaSchemeDetails(mockSchemeDetails, Nil, Nil, None)
