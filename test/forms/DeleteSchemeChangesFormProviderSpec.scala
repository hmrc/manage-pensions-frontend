...
class DeleteSchemeChangesFormProviderSpec extends FormSpec {

  val requiredKey = "messages__deleteSchemeChanges__error__required"
  val invalidKey = "error.boolean"

  val formProvider = new DeleteSchemeChangesFormProvider()

  "DeleteSchemeChanges Form Provider" must {
